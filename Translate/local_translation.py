...
def setup_logging():
    ...
    logging.basicConfig(
        ...
        format=log_format,
        handlers=[
            logging.FileHandler('local_translation.log', encoding='utf-8'),
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Translate SRT subtitles from Chinese to Vietnamese using local model")
