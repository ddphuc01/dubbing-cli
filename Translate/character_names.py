...
if __name__ == "__main__":
    # Khởi tạo quản lý tên nhân vật
    name_manager = CharacterNameManager()
    
    # Thêm một số tên nhân vật mẫu
    name_manager.add_character_name("张三", "Trương Tam")
    name_manager.add_character_name("李四", "Lý Tứ")
    name_manager.add_character_name("王五", "Vương Ngũ")
    
    # Ví dụ tiền xử lý văn bản
    original_text = "张三说：你好，我是张三。李四在做什么？"
    processed = name_manager.preprocess_text_with_names(original_text)
    print(f"Original: {original_text}")
    print(f"Processed: {processed}")
    
    # Ví dụ hậu xử lý văn bản (giả lập văn bản đã dịch)
    translated_text = "{CHARACTER_NAME:张三} nói: Xin chào, tôi là {CHARACTER_NAME:张三}. {CHARACTER_NAME:李四} đang làm gì?"
    postprocessed = name_manager.postprocess_text_with_names(translated_text)
